...
Email OTP only (MVP). Google OAuth and SMS are deferred — see [`docs/roadmap.md`](docs/roadmap.md).
...
### Auth / email OTP testing
OTP emails are not really sent locally — they are captured by Inbucket at `http://127.0.0.1:54324`. To log in: enter an email on the app, click **Send code**, open Inbucket, and copy the 6-digit code into the app.
